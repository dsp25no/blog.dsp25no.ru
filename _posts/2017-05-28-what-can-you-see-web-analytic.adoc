...
Если кратко, то небезопасно. Но подключение Javascript-плагинов на страницах входа в интернет-банк не единичный случай. Подробнее в работе:

[source,pdf]
----
include::https://github.com/dsp25no/blog.dsp25no.ru/raw/gh-pages/data/Diplom.pdf[]
----